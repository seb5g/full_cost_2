...
ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", default="localhost full-cost.cemes.fr 127.0.0.1".split())
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'lab.context_processors.get_all_activity', #to have access to this within the templates, see lab/navbar.html
            ],
        },
    },
]
