...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price_category', models.CharField(choices=[('T1', 'CNRS and partners'), ('T2', 'Academic'), ('T3', 'Private')], default=fullcoster.constants.entities.PriceCategory['T1'], max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.CharField(choices=[('MET', 'Transmission Electron Microscopy Platform'), ('PREPA', 'Sample Preparation Service'), ('FIB_MEB', 'Focused Ion Beam and MEB'), ('OSM', 'Optical Spectroscopy and Magnetism'), ('CARAC', 'Material Characterisation'), ('NANOFAB', 'NanoFabrication'), ('CHEM', 'Chemistry'), ('GROWTH_IMP', 'Growth and Implantation'), ('STM_AFM', 'UHV Imagery'), ('ENGINEERING', 'Engineering')], default=('MET', 'Transmission Electron Microscopy Platform'), max_length=200)),
