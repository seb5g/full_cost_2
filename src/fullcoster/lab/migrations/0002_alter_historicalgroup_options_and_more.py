    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default=None, null=True,
                                    on_delete=django.db.models.deletion.SET_NULL, to='lab.gestionnaire'),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_constraint=False,
                                    ...
                                    related_name='+', to='lab.gestionnaire'),
        ),
        migrations.AddField(
            model_name='historicalproject',
            name='is_academic',
        ...
        migrations.AlterField(
            model_name='extraction',
            name='billing',
            field=models.CharField(choices=[('MET_C', 'Conventionnal TEM'),
                                            ('MET_A', 'Advanced TEM'),
        ...
        migrations.AlterField(
            model_name='price',
            name='price_category',
            field=models.CharField(choices=[('T1', 'CNRS Interne'), ('T2', 'CNRS Externe'), ('T3', 'Private')],
                                   default=entities.PriceCategory['T1'], max_length=200),
        ),
        migrations.AlterField(
            model_name='price',
            name='price_entity',
